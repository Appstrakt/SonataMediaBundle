                    ...
                    ->children()
                        ...
                        ->arrayNode('s3')
                            ->children()
                                ...
                                ->scalarNode('s3_region')->defaultValue('eu-west-1')->end()
                                ->scalarNode('s3_version')->defaultValue('2006-03-01')->end()
                                ->arrayNode('credentials')
                                    ->children()
                                        ->scalarNode('key')->defaultValue(false)->end()
                                        ->scalarNode('secret')->defaultValue(false)->end()
                                    ->end()
                                ->end()
                                ->scalarNode('create')->defaultValue(false)->end()
                                ->scalarNode('storage')
